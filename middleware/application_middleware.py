...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_9ba72266a85a4601af89eb1ef39b5126
    """
    try:
...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_b876f384ab0e4e0da6eaaef72a2b6cf4
    """
    try:
        ...
        auth_package_secret_key = """Eu0zwo38bWFLN6tubJBaHHwBkbic_TpGfWmUYRob9tg="""
